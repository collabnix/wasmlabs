...
| 9 | Fermyon / Spin | Fermyon created Spin, an open source framework for building and running cloud microservices with WebAssembly. | [spin](https://github.com/fermyon/spin) |
